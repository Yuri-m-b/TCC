...
// static esp_zb_ep_list_t *custom_temperature_sensor_ep_create(uint8_t endpoint_id, custom_sensor_cfg_t *temperature_sensor)
// {
//     esp_zb_ep_list_t *ep_list = esp_zb_ep_list_create();
//     esp_zb_endpoint_config_t endpoint_config = {
//         .endpoint = endpoint_id,
...
//     char buffer[256];
//     trap_state_t mqqt_trap_info;

//     for (;;)
//     {   
//         battery_voltage = read_battery_voltage();

//         /* Read global trap info */
//         xSemaphoreTake(xSemaphore_trap_state, portMAX_DELAY);
//         my_trap_state.battery = battery_voltage;
//         mqqt_trap_info = my_trap_state;
//         xSemaphoreGive(xSemaphore_trap_state);

//         ret = encode_trap_json_data(&mqqt_trap_info, buffer, 256);

//         if (ret < 0){
//             ESP_LOGD(TAG, "Failed to encode json data");
//         }
//         else
//         {
//             ESP_LOGD(TAG, "%s", buffer);
//             mqtt5_publish("traps/", buffer); 
//         }
