...
esp_err_t read_temperature(i2c_master_dev_handle_t dev_handle, float *temp_c) {
    ...
    // Envia comando: TRIGGER_TEMP_MEASURE_NOHOLD
...
void init_i2c(i2c_master_bus_handle_t *bus_handle, i2c_master_dev_handle_t *dev_handle) {
...
static void i2c_HTU2X_task(void *pvParameters)
{
    ...
    init_i2c(&bus_handle, &dev_handle);
